...
COPY 3rdparty /map-server/3rdparty
COPY conf /map-server/conf
COPY db /map-server/db
COPY npc /map-server/npc
COPY src /map-server/src
COPY configure /map-server/configure
COPY configure.in /map-server/configure.in
COPY Makefile.in /map-server/Makefile.in
